...
/* ===== Serial Bridge ===== */
// Uncomment these if you're using the Serial Bridge functionality.
// #define BRIDGE_ENABLE
// #define BRIDGE_PORT Serial1  // Use Serial1 for Teensy
// #define BRIDGE_SWITCH 6      // Adjust pin number if needed for Teensy
// #define BRIDGE_RST 4
// #define BRIDGE_0 5
...
/*! DEBUG Settings */
#define ENABLE_DEBUG  // Enable debug output
#define DEBUG_PORT Serial  // Use Serial for debugging (Teensy main port)
...
/*! ===== LED Settings ===== */
#define LED_PIN 13  // Teensy 3.6 onboard LED
...
#define DEFAULT_SLEEP 5 // Default delay between keystrokes
